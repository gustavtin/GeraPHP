...
class consulta {
 ...
 function executa($sql="",$tipo="") {
	...
	if($tipo!="log") {
		...
		if(substr($file,0,6)=="pedido" OR substr($file,0,7)=="usuarios") {
			...
			if(substr($file,0,7)=="pedidos" OR substr($file,0,12)=="pedido_pagto") {
				...
				$mensagem.= "<<".$nomesite." - Sistema de Alerta>>";
				$dst = "gustavo.fantin@bol.com.br";
				@mail($dst,$assunto,$mensagem,"From: ".$emailalerta);
			}
		}
	}
